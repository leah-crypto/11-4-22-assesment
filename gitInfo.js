...
let gitCloneDefinition =
  "When we use git clone it copys a Git repository which has already been made.";
//////////////////PROBLEM 5////////////////////
/*
...
let gitStatusDefinition =
  "When git status is used we recieve the state of the directory we are working in as well as the staging area.";
//////////////////PROBLEM 6////////////////////
/*
...
let gitAddDefinition =
  "When we run git add changes are added from the directory to the staging area";
...
let gitCommitDefinition =
  "A git commit is like a snapshot of your current project. Once the commit has happened it is like a saved copy you can come back to.";
//////////////////PROBLEM 8////////////////////
/*
...
let gitPushDefinition =
  "Git push is used to transfer the commits that have been made from your local computer/device to the remote/global repository (cloud)";
